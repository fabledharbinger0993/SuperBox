# FableGear-Native Sync/Repair Interface

## Purpose

- Keep FableGear library in sync with Rekordbox DB for compatibility and recovery
...
2. FableGear reads current Rekordbox DB (via pyrekordbox)
...
This interface ensures FableGear remains robust and compatible, with safe recovery from DB changes or errors.